package com.orders.config.kafka;
...
public class KafkaConfig {
    ...
    @Value("${kafka.topic.orders-success}")
    private String orders_successTopic;
    @Value("${kafka.topic.orders-fail}")
    private String orders_failTopic;
    ...
    public NewTopic orders_successTopic(){
        return buildTopic(orders_successTopic);
    }

    @Bean
    public NewTopic orders_failTopic(){
        return buildTopic(orders_failTopic);
    }
}
